...
// 	// The harness must tear the devnet down on both Ctrl-C and SIGTERM.
// 	has := map[os.Signal]bool{}
// 	for _, s := range shutdownSignals {
// 		has[s] = true
// 	}

// 	require.Equal(t, true, has[os.Interrupt])
// 	require.Equal(t, true, has[syscall.SIGTERM])
// }

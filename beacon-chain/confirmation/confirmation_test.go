...
func (m *mockBalanceAccessor) PulledUpHeadState(_ context.Context) (*FFGStateInfo, error) {
...
func TestNew(t *testing.T) {
	...
	fcr := New(&mockForkchoiceReader{}, &mockCommitteeAccessor{}, &mockBalanceAccessor{}, anchor, anchorCp)
...
func TestOnFastConfirmation_NoChange(t *testing.T) {
	...
	fcr := New(fc, &mockCommitteeAccessor{}, &mockBalanceAccessor{}, anchor, anchorCp)
...
func TestIsConfirmedChainSafe_Passes(t *testing.T) {
	...
	fcr := New(fc, &mockCommitteeAccessor{}, &mockBalanceAccessor{}, root0, anchorCp)
...
func TestGetLatestConfirmed_RestartsToJustified(t *testing.T) {
	...
	fcr := New(fc, &mockCommitteeAccessor{}, &mockBalanceAccessor{}, rootFin, anchorCp)
